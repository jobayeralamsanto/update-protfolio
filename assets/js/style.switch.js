...
button.on("click", function() { var r = jQuery(this); return r.hasClass("showme") || (button.removeClass("showme"), r.addClass("showme")), !1 }), show.on("click", function() { wrapper.attr("data-magic-cursor", "") }), hide.on("click", function() { wrapper.attr("data-magic-cursor", "hide") });
var isMobile = !!/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent),
    preloader = $("#preloader");
isMobile ? preloader.remove() : (setTimeout(function() { preloader.addClass("preloaded") }, 800), setTimeout(function() { preloader.remove() }, 2e3));